...
void print_list(t_d_list *list); // todo

void print_aligned_level(t_d_list *list, int level);

void print_aligned_list(t_d_list *list); // todo
...
t_d_list * create_filled_list(int n_levels); // todo

int classic_search(t_d_list *list, int value); // todo

int optimized_search(t_d_list *list, int value); // todo
